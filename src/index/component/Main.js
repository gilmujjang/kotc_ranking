    ...
    <div className={styles.main}>
      <div
        className={classNames({
          ["container"]: true,
          [styles.container__index__main]: true,
        })}
      >
        <div className={styles.main__section}>
          <div className={styles.greeting}>
            <h1>
              'Play. &'는 온라인 모임 공간을 찾던 테니스 동호인들을 위한 새로운
              정답이 될&nbsp;것입니다.
            </h1>
            <h2>
              'Play. &'와 함께 실력을 쌓아가고 새로운 만남을 이어나가세요.
            </h2>
          </div>
          <div
            className={classNames({
              ["button__index"]: true,
              [styles.button__index__main]: true,
            })}
          >
        ...
        <div className={styles.main__section}>
          <div className={styles.introduce}>
            <div className={styles.introduce__board}>
              ...
              <p className={styles.introduce__expression}>
                그룹원들에게 중요한 사항을 전달하세요.
              </p>
              {/* 버튼 추가 혹은 버튼 없이 */}
            </div>
