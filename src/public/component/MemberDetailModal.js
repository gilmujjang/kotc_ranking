    ...
    <>
      <div className={styles.detail__profile}>
        {playerDetailTarget.photoURL ? (
          ...
          <img
            src="https://d2u3dcdbebyaiu.cloudfront.net/uploads/atch_img/68/d768b6caa2c0d23507bc12087bf171a8.jpeg"
      ...
      <div>
        ...
        <span className={styles.detail__status}>
          {playerDetailTarget.status}
        </span>
      </div>
    </>
  );
    ...
    <>
      <div
        className={classNames({
          ["button"]: true,
          [styles.button__memberDetail]: true,
        })}
        onClick={periodFilterHandler}
        data-period="30"
      >
        30일
      </div>
        ...
        <Modal.Description ref={modalRef}>
          <div className={styles.modal__player_detail}>
            <div className={styles.top}>
              <div className={styles.top__left}>{info}</div>
              <div
                className={classNames({
                  [styles.top__circleRate]: true,
                  [styles.winning_rate]: true,
                })}
              >
                <MemberDetailWinningRate
                  playerDetailTarget={playerDetailTarget}
                />
              </div>
              <div
                className={classNames({
                  [styles.top__circleRate]: true,
                  [styles.ranking_rate]: true,
                })}
              >
                <MemberDetailRankingRate
                  playerDetailTarget={playerDetailTarget}
